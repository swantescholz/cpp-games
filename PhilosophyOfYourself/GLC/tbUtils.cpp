...
std::string	operator+= (      std::string &s, float  f) {char c[40]; sprintf(c, "%f", f); s+=c; return s;} //<- hier ggf. precision angeben
std::string	operator+  (const std::string &s, float  f) {char c[40]; sprintf(c, "%f", f); return (s + c);} //<- hier ggf. precision angeben
std::string	operator+= (      std::string &s, double d) {char c[40]; sprintf(c, "%g", d); s+=c; return s;} //<- hier ggf. precision angeben
std::string	operator+  (const std::string &s, double d) {char c[40]; sprintf(c, "%g", d); return (s + c);} //<- hier ggf. precision angeben
...
std::string	operator+  (float  f, const std::string &s) {char c[40]; sprintf(c, "%f", f); return c +  s;} //<- hier ggf. precision angeben
std::string	operator+  (double d, const std::string &s) {char c[40]; sprintf(c, "%g", d); return c +  s;} //<- hier ggf. precision angeben
//ende von S. Scholz
