#ifndef CRASHARGUMENT_H_
#define CRASHARGUMENT_H_
...
class CRashArgument : public CObject
{
public:
	CRashArgument(tbVector2 pvStartPos, string psThought);
	~CRashArgument();
	...
	bool IsPushed()	 {return m_bIsPushed;}
...
private:
	...
	bool		m_bIsPushed;		//am i pushed, or just sliding (in x - direction)
