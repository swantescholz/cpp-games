...
public:
	...
	static void LoadMusic	(string sPath, const float factor = 1.0f, const double dFadeIn = 0.0, const double dPos = 0.0);
	static void DeleteMusic	(string sPath, bool bCompleteThePath = false);
